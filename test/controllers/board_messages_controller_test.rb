...
class BoardMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create board_message" do
    assert_difference('BoardMessage.count') do
      post board_messages_url, params: { board_message: { board_user_id: @board_message.board_user_id, message: @board_message.message } }
    end
  ...
  test "should update board_message" do
    patch board_message_url(@board_message), params: { board_message: { board_user_id: @board_message.board_user_id, message: @board_message.message } }
