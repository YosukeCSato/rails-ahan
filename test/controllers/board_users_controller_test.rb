...
class BoardUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create board_user" do
    assert_difference('BoardUser.count') do
      post board_users_url, params: { board_user: { account_id: @board_user.account_id, introduce: @board_user.introduce, nickname: @board_user.nickname } }
    end
  ...
  test "should update board_user" do
    patch board_user_url(@board_user), params: { board_user: { account_id: @board_user.account_id, introduce: @board_user.introduce, nickname: @board_user.nickname } }
